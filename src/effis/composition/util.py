    ...
    def __init__(self, value, link=False, rename=None, outpath=None, key=""):
        ...
        if type(value) is not str:
            CompositionLogger.RaiseError(
                ValueError,
                "Invalid Input {0}={1} --> Must be a string (path)".format(
                    key, str(value)
                )
            )
            ...
            CompositionLogger.RaiseError(
                FileNotFoundError,
                "Invalid file path: Cannot find Input path {0}={1}".format(
                    key, value
                )
            )
            ...
            CompositionLogger.RaiseError(
                ValueError,
                (
                    "Invalid assignment: link attribute of Input is set as "
                    "either True or False -- gave {0}".format(str(link))
                )
            )
            ...
            CompositionLogger.RaiseError(
                ValueError,
                (
                    "Invalid assignment: rename attribute of Input is set as "
                    "a string -- gave {0}".format(str(rename))
                )
            )
            ...
            CompositionLogger.RaiseError(
                ValueError,
                (
                    "Invalid assignment: outpath attribute of Input is set as "
                    "a string -- gave {0}".format(str(outpath))
                )
            )
...
class ListType:
    ...
    def __iadd__(self, value):
        ...
        if type(value) is type(self):
            ...
            (not isinstance(value, self.astype))
            and
